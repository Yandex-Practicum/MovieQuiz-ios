...
class MovieLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        // Given
        let stubNetworklClient = StubNetworkClient(emulateError: false) // не эмулируем ошибку
        let loader = MoviesLoader(networkClient: stubNetworklClient)
    ...
    func testFailureLoading() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(emulateError: true) // проверяем ошибка
...
struct StubNetworkClient: NetworkRouting {
    ...
    let emulateError: Bool // нужно, чтобы заглушка эмулировала либо ошибку сети, либо успех
