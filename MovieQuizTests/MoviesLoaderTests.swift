...
//  MovieQuizTests
//
//  Created by Мария Авдеева on 08.01.2023.
//
...
class MoviesLoaderTests: XCTestCase {
    ...
    func testSuccesLoading() throws {
        ...
        // Given
        let stubNetworkCkient = StubNetworkClient(emulateError: false)
        let loader = MoviesLoader(networkClient: stubNetworkCkient)
    ...
    func testFailureLoading() throws {
        // Given
        let stubNetworkCkient = StubNetworkClient(emulateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkCkient)
        // When
        let expectation = expectation(description: "Loading expectation")
