...
final class MovieQuizViewController: UIViewController {
    ...
    private func showAnswerResult(isCorrect: Bool) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) { [weak self] in // Добавлены слабые ссылки
    ...
    private func show(quiz result: QuizResultsViewModel) {
        ...
        let action = UIAlertAction(title: result.buttonText, style: .default) { [weak self] _ in // Добавлены слабые ссылки
            guard let self = self else { return }
