...
final class MovieQuizViewController: UIViewController {
    ...
    // Эти mock-данные могут быть описаны такой структурой
    struct QuizQuestion {
        let image: String
        let text: String
    ...
    @IBAction private func ButtonNoDidTap(_ sender: Any) {
        let currentQuestion = questions[currentQuestionIndex]
        let givenAnswer = false
        showAnswerResult(isCorrect: givenAnswer == currentQuestion.correctAnswer)
    }
    
    @IBAction private func ButtonYesDidTap(_ sender: Any) {
        let currentQuestion = questions[currentQuestionIndex]
