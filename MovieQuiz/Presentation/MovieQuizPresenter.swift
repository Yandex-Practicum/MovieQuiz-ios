...
//
////    init(viewController: MovieQuizViewController) { //Да
...
//         }
//
//    func isLastQuestion() -> Bool { //Да
//            currentQuestionIndex == questionsAmount - 1
//        }
//
//    func switchToNextQuestion() { //Да
//            currentQuestionIndex += 1
//        }
//
//    func convert(model: QuizQuestion) -> QuizStepViewModel { //Да
...
//    }
//
//    func yesButtonClicked() { //Да
//        didAnswer(isYes: true)
//       }
//
//    func noButtonClicked() { //Да
...
//     }
//
//    private func proceedToNextQuestionOrResults() { //Да
